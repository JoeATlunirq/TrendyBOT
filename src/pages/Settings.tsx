                             ...
                             return (
                                 ...
                                 >
                                     <CardHeader className="pb-4">
                                          {/* Only show Most Popular badge if it's NOT the current plan */}
                                     ...
                                     <CardFooter className="flex-col items-stretch">
                                         {isCurrentPlan ? (
                                            // If this is the current plan, show Cancel button
                                            <Button 
                                                variant="destructive"
                                            ...
                                            >
                                             ...
                                             // If this is NOT the current plan, show PayPal Subscribe button
