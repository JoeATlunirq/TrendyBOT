...
// app.use('/api/paypal', paypalRoutes); // Commented out as paypalRoutes is not defined
...
server.listen(PORT, async () => { // KEEP LISTEN COMMENTED OUT FOR VERCEL
  console.log(`<<<<< Server listening on PORT ${PORT} >>>>>`); // Add log for confirmation
